 ...
 *
 * Converges the five feature migrations landed under this milestone
 * (add_equipment_detail -> add_player_item_stat -> add_guild_sync_config ->
 * add_news_source -> add_achievement_category_guild_flag, already a single
 * linear chain) behind one canonically-named
